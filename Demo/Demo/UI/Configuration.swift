...
#if os(macOS)
let appGroup = "AGQKFKH6RB.group.com.antalyasoftware.TunnelKit.Demo"
private let bundleComponent = "macos"
#elseif os(iOS)
let appGroup = "group.com.antalyasoftware.TunnelKit.Demo"
...
enum TunnelIdentifier {
    static let openVPN = "com.antalyasoftware.\(bundleComponent).TunnelKit.Demo.OpenVPN-Tunnel"
}
